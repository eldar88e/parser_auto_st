class Exporter < Hamster::Harvester
  ...
  def convert_objects_list(games_raw, domain)
    ...
    games_raw.each do |game|
      ...
      item[3] = game.sony_game_additional.price.to_i
      item[4] = game.sony_game_additional.old_price&.to_i
      sony_id = game.sony_game_additional.janr
      item[5] = "https://store.playstation.com/store/api/chihiro/00_09_000/container/IN/en/99/#{sony_id}/0/image?w=600&h=600"
      ...
      seo      = Hamster::Seo.new(domain, game.pagetitle, item[10])
      item[12] = seo.title
